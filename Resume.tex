...
& \footnotesize{Coding, Teaching, Programming Challanges, Competitive Programming Contests, designing mobile applications, learning new programming languages, Searching about science}
\end{tabular}
...
\item \textbf{NOTE}: You can find some of those projects on my Github! https://github.com/EstebanFS
\end{enumerate}
