...
\section{About Me}
\begin{tabular}{r|p{11cm}}
& \footnotesize{I'm just a curious person that really loves learn new things, I really like ask me, how everything works and how it could be improve?, because I think nothing is in a final state, everything can be evolve in a new wonderful thing with new features.
\newline
\newline
I love the way that is possible to mix science and technology to make thing faster and better, that's why I would love to find a way to contribute from my knowledge at this area.
\newline
\newline
I'm a person that love what he does, and tries ever to do thing that really loves, I strongly agree with the idea that the only way to be happy is doing what you love, doesn't matter how much money you could earn doing another thing, how comfortable you could be right now, or simply how hard that could be get it, you have to try it and keep looking it.
\newline
\newline
I also love work with others, because, I think each person can learn amazing things of other person, and I'm not talking just in a professional way, each persons have a lot to teach you, if you are open enough to see it and receive it.
\newline
\newline
Finally I love to teach, I think to see people interested by something trying to improve his knowledge and reaching his goals is wonderful, that's why I love it, specially when a person have a truly intention to learn. I strongly agree with the idea that knowledge is not something you can restrict and transmit it its the best way to make society better.}
\end{tabular}
