...
%%% Icons
\newcommand*{\icon}[1]{\includegraphics[width=1em, height=1em]{#1}}
...
\definecolor{blue-gray}{HTML}{607D8B}
\colorlet{awesome}{blue-gray}
...
%%% Essentials
\name{Esteban}{Foronda}
\mobile{(+57) 3218350291}
%%% Social
\email{seforonda@gmail.com}
\github{EstebanFS}
\linkedin{EstebanFS-01}
%%% Optionals
\position{Software Engineer{\dotsep}FULL STACK DEVELOPER}
